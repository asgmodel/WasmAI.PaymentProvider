...
namespace WasmAI.PaymentProvider.Controllers.Api
{
    ...
    [ApiController]
    public class InvoiceController : BaseBPRControllerLayer<InvoiceRequestDso, InvoiceResponseDso, InvoiceCreateVM, InvoiceOutputVM, InvoiceUpdateVM, InvoiceInfoVM, InvoiceDeleteVM>
    {

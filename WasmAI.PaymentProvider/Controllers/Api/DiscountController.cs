...
namespace WasmAI.PaymentProvider.Controllers.Api
{
    ...
    [ApiController]
    public class DiscountController : BaseBPRControllerLayer<DiscountRequestDso, DiscountResponseDso, DiscountCreateVM, DiscountOutputVM, DiscountUpdateVM, DiscountInfoVM, DiscountDeleteVM>
    {

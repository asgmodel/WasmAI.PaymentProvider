...
namespace WasmAI.PaymentProvider.Controllers.Api
{
    ...
    [ApiController]
    public class CustomerController : BaseBPRControllerLayer<CustomerRequestDso, CustomerResponseDso, CustomerCreateVM, CustomerOutputVM, CustomerUpdateVM, CustomerInfoVM, CustomerDeleteVM>
    {

...
namespace WasmAI.PaymentProvider.Controllers.Api
{
    ...
    [ApiController]
    public class ProviderPaymentController : BaseBPRControllerLayer<ProviderPaymentRequestDso, ProviderPaymentResponseDso, ProviderPaymentCreateVM, ProviderPaymentOutputVM, ProviderPaymentUpdateVM, ProviderPaymentInfoVM, ProviderPaymentDeleteVM>
    {

...
{
    /// <summary>
    /// Customer class for ShareRepository.
    /// </summary>
    public class CustomerShareRepository : BaseBPRShareLayer<CustomerRequestShareDto, CustomerResponseShareDto, CustomerRequestBuildDto, CustomerResponseBuildDto>, ICustomerShareRepository
    {
        // Declare the builder repository.
        private readonly CustomerBuilderRepository _builder;
        public CustomerShareRepository(IMapper mapper, ILoggerFactory logger, CustomerBuilderRepository bpr) : base(mapper, logger, bpr)
        {
            _builder = bpr;
        }
    }

...
{
    /// <summary>
    /// Customer interface for RepositoriesRepository.
    /// </summary>
    public interface ICustomerShareRepository : IBaseShareRepository<CustomerRequestShareDto, CustomerResponseShareDto> //
    , IBaseBPRShareLayer<CustomerRequestShareDto, CustomerResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,ICustomerBuilderRepository<CustomerRequestShareDto, CustomerResponseShareDto>
    {

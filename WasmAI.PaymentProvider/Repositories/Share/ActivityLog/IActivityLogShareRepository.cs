...
{
    /// <summary>
    /// ActivityLog interface for RepositoriesRepository.
    /// </summary>
    public interface IActivityLogShareRepository : IBaseShareRepository<ActivityLogRequestShareDto, ActivityLogResponseShareDto> //
    , IBaseBPRShareLayer<ActivityLogRequestShareDto, ActivityLogResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IActivityLogBuilderRepository<ActivityLogRequestShareDto, ActivityLogResponseShareDto>
    {

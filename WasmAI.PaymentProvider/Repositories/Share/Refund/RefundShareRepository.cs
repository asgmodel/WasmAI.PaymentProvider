...
{
    /// <summary>
    /// Refund class for ShareRepository.
    /// </summary>
    public class RefundShareRepository : BaseBPRShareLayer<RefundRequestShareDto, RefundResponseShareDto, RefundRequestBuildDto, RefundResponseBuildDto>, IRefundShareRepository
    {
        // Declare the builder repository.
        private readonly RefundBuilderRepository _builder;
        public RefundShareRepository(IMapper mapper, ILoggerFactory logger, RefundBuilderRepository bpr) : base(mapper, logger, bpr)
        {
            _builder = bpr;
        }
    }

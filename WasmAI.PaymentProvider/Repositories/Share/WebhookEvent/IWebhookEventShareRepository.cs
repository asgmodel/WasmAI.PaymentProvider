...
{
    /// <summary>
    /// WebhookEvent interface for RepositoriesRepository.
    /// </summary>
    public interface IWebhookEventShareRepository : IBaseShareRepository<WebhookEventRequestShareDto, WebhookEventResponseShareDto> //
    , IBaseBPRShareLayer<WebhookEventRequestShareDto, WebhookEventResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IWebhookEventBuilderRepository<WebhookEventRequestShareDto, WebhookEventResponseShareDto>
    {

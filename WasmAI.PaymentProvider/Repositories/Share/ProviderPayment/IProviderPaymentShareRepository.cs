...
{
    /// <summary>
    /// ProviderPayment interface for RepositoriesRepository.
    /// </summary>
    public interface IProviderPaymentShareRepository : IBaseShareRepository<ProviderPaymentRequestShareDto, ProviderPaymentResponseShareDto> //
    , IBaseBPRShareLayer<ProviderPaymentRequestShareDto, ProviderPaymentResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IProviderPaymentBuilderRepository<ProviderPaymentRequestShareDto, ProviderPaymentResponseShareDto>
    {

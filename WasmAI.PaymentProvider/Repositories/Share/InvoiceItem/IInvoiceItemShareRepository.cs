...
{
    /// <summary>
    /// InvoiceItem interface for RepositoriesRepository.
    /// </summary>
    public interface IInvoiceItemShareRepository : IBaseShareRepository<InvoiceItemRequestShareDto, InvoiceItemResponseShareDto> //
    , IBaseBPRShareLayer<InvoiceItemRequestShareDto, InvoiceItemResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IInvoiceItemBuilderRepository<InvoiceItemRequestShareDto, InvoiceItemResponseShareDto>
    {

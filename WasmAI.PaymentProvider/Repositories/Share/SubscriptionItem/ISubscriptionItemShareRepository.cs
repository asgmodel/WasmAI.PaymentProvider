...
{
    /// <summary>
    /// SubscriptionItem interface for RepositoriesRepository.
    /// </summary>
    public interface ISubscriptionItemShareRepository : IBaseShareRepository<SubscriptionItemRequestShareDto, SubscriptionItemResponseShareDto> //
    , IBaseBPRShareLayer<SubscriptionItemRequestShareDto, SubscriptionItemResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,ISubscriptionItemBuilderRepository<SubscriptionItemRequestShareDto, SubscriptionItemResponseShareDto>
    {

...
{
    /// <summary>
    /// PaymentMethod interface for RepositoriesRepository.
    /// </summary>
    public interface IPaymentMethodShareRepository : IBaseShareRepository<PaymentMethodRequestShareDto, PaymentMethodResponseShareDto> //
    , IBaseBPRShareLayer<PaymentMethodRequestShareDto, PaymentMethodResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IPaymentMethodBuilderRepository<PaymentMethodRequestShareDto, PaymentMethodResponseShareDto>
    {

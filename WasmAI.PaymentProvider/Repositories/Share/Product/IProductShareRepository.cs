...
{
    /// <summary>
    /// Product interface for RepositoriesRepository.
    /// </summary>
    public interface IProductShareRepository : IBaseShareRepository<ProductRequestShareDto, ProductResponseShareDto> //
    , IBaseBPRShareLayer<ProductRequestShareDto, ProductResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IProductBuilderRepository<ProductRequestShareDto, ProductResponseShareDto>
    {

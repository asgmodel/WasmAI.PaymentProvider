...
{
    /// <summary>
    /// Discount interface for RepositoriesRepository.
    /// </summary>
    public interface IDiscountShareRepository : IBaseShareRepository<DiscountRequestShareDto, DiscountResponseShareDto> //
    , IBaseBPRShareLayer<DiscountRequestShareDto, DiscountResponseShareDto>
    //  يمكنك  التزويد بكل  دوال   طبقة Builder   ببوابات  الطبقة   هذه نفسها      
    //,IDiscountBuilderRepository<DiscountRequestShareDto, DiscountResponseShareDto>
    {

...
{
    /// <summary>
    /// PaymentMethod interface property for BuilderRepository.
    /// </summary>
    public interface IPaymentMethodBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

...
{
    /// <summary>
    /// Product interface property for BuilderRepository.
    /// </summary>
    public interface IProductBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

...
{
    /// <summary>
    /// WebhookEvent interface property for BuilderRepository.
    /// </summary>
    public interface IWebhookEventBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

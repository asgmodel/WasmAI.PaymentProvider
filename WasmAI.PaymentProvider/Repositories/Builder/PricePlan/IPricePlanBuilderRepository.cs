...
{
    /// <summary>
    /// PricePlan interface property for BuilderRepository.
    /// </summary>
    public interface IPricePlanBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

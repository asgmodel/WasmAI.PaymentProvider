...
{
    /// <summary>
    /// Discount interface property for BuilderRepository.
    /// </summary>
    public interface IDiscountBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

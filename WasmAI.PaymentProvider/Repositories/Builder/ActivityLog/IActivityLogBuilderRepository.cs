...
{
    /// <summary>
    /// ActivityLog interface property for BuilderRepository.
    /// </summary>
    public interface IActivityLogBuilderRepository<TBuildRequestDto, TBuildResponseDto> : IBPRLayer<TBuildRequestDto, TBuildResponseDto> //

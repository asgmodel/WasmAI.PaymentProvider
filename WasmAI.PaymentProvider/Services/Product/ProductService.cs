...
{
    public class ProductService : BaseBPRServiceLayer<ProductRequestDso, ProductResponseDso, ProductRequestShareDto, ProductResponseShareDto>, IUseProductService
    {
        private readonly IProductShareRepository _share;
        public ProductService(IMapper mapper, ILoggerFactory logger, IProductShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }

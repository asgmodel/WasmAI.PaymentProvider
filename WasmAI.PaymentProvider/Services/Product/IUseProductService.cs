...
{
    public interface IUseProductService : IProductService<ProductRequestDso, ProductResponseDso>, IBaseService, IBaseBPRServiceLayer<ProductRequestDso, ProductResponseDso>
    {
    }
}
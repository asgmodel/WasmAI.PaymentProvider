...
{
    public class PricePlanService : BaseBPRServiceLayer<PricePlanRequestDso, PricePlanResponseDso, PricePlanRequestShareDto, PricePlanResponseShareDto>, IUsePricePlanService
    {
        private readonly IPricePlanShareRepository _share;
        public PricePlanService(IMapper mapper, ILoggerFactory logger, IPricePlanShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }

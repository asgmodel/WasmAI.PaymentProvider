...
{
    public interface IUsePricePlanService : IPricePlanService<PricePlanRequestDso, PricePlanResponseDso>, IBaseService, IBaseBPRServiceLayer<PricePlanRequestDso, PricePlanResponseDso>
    {
    }
}
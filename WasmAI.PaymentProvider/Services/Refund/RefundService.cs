...
{
    public class RefundService : BaseBPRServiceLayer<RefundRequestDso, RefundResponseDso, RefundRequestShareDto, RefundResponseShareDto>, IUseRefundService
    {
        private readonly IRefundShareRepository _share;
        public RefundService(IMapper mapper, ILoggerFactory logger, IRefundShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }

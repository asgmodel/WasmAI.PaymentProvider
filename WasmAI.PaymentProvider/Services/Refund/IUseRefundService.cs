...
{
    public interface IUseRefundService : IRefundService<RefundRequestDso, RefundResponseDso>, IBaseService, IBaseBPRServiceLayer<RefundRequestDso, RefundResponseDso>
    {
    }
}
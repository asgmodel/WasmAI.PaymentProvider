...
{
    public interface IUseWebhookEventService : IWebhookEventService<WebhookEventRequestDso, WebhookEventResponseDso>, IBaseService, IBaseBPRServiceLayer<WebhookEventRequestDso, WebhookEventResponseDso>
    {
    }
}
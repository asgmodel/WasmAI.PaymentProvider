...
{
    public interface IUseInvoiceItemService : IInvoiceItemService<InvoiceItemRequestDso, InvoiceItemResponseDso>, IBaseService, IBaseBPRServiceLayer<InvoiceItemRequestDso, InvoiceItemResponseDso>
    {
    }
}
...
{
    public interface IUseCustomerService : ICustomerService<CustomerRequestDso, CustomerResponseDso>, IBaseService, IBaseBPRServiceLayer<CustomerRequestDso, CustomerResponseDso>
    {
    }
}
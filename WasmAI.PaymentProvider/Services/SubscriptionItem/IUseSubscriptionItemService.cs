...
{
    public interface IUseSubscriptionItemService : ISubscriptionItemService<SubscriptionItemRequestDso, SubscriptionItemResponseDso>, IBaseService, IBaseBPRServiceLayer<SubscriptionItemRequestDso, SubscriptionItemResponseDso>
    {
    }
}
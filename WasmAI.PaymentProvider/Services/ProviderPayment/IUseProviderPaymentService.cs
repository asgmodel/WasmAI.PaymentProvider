...
{
    public interface IUseProviderPaymentService : IProviderPaymentService<ProviderPaymentRequestDso, ProviderPaymentResponseDso>, IBaseService, IBaseBPRServiceLayer<ProviderPaymentRequestDso, ProviderPaymentResponseDso>
    {
    }
}
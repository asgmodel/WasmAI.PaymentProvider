...
{
    public class PaymentMethodService : BaseBPRServiceLayer<PaymentMethodRequestDso, PaymentMethodResponseDso, PaymentMethodRequestShareDto, PaymentMethodResponseShareDto>, IUsePaymentMethodService
    {
        private readonly IPaymentMethodShareRepository _share;
        public PaymentMethodService(IMapper mapper, ILoggerFactory logger, IPaymentMethodShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }

...
{
    public interface IUsePaymentMethodService : IPaymentMethodService<PaymentMethodRequestDso, PaymentMethodResponseDso>, IBaseService, IBaseBPRServiceLayer<PaymentMethodRequestDso, PaymentMethodResponseDso>
    {
    }
}
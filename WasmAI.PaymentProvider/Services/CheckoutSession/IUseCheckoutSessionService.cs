...
{
    public interface IUseCheckoutSessionService : ICheckoutSessionService<CheckoutSessionRequestDso, CheckoutSessionResponseDso>, IBaseService, IBaseBPRServiceLayer<CheckoutSessionRequestDso, CheckoutSessionResponseDso>
    {
    }
}
...
{
    public interface IUseActivityLogService : IActivityLogService<ActivityLogRequestDso, ActivityLogResponseDso>, IBaseService, IBaseBPRServiceLayer<ActivityLogRequestDso, ActivityLogResponseDso>
    {
    }
}
...
{
    public class ActivityLogService : BaseBPRServiceLayer<ActivityLogRequestDso, ActivityLogResponseDso, ActivityLogRequestShareDto, ActivityLogResponseShareDto>, IUseActivityLogService
    {
        private readonly IActivityLogShareRepository _share;
        public ActivityLogService(IMapper mapper, ILoggerFactory logger, IActivityLogShareRepository bpr) : base(mapper, logger, bpr)
        {
            _share = bpr;
        }
    }

...
{
    public interface IUseDiscountService : IDiscountService<DiscountRequestDso, DiscountResponseDso>, IBaseService, IBaseBPRServiceLayer<DiscountRequestDso, DiscountResponseDso>
    {
    }
}